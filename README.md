...
export_to_html(
    ...
    title="KaroSpace",
    tutorial=False,              # Set True to autostart the guided HTML tutorial
...
| `--tutorial` | Embed and autostart the guided HTML tutorial on first open; users can disable/restart it inside the viewer | off |
