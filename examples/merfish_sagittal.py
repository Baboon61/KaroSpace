...
H5AD_PATH = '/Volumes/processing2/KaroSpaceDataWrangle/raw/merfish/processed_mapped/adata_sagittal_mapped_scVI_GMM.h5ad'#'/Volumes/processing2/RRmap/data/EAE_proseg_clustered_louvain_leiden_all_sections_annotated_rotated_scVI_mana_embedding_clustered.h5ad'
...
export_to_html(
    dataset,
    output_path="Merfish_sag.html",
    color="gmm_CC_10",  # Initial color (categorical)
    title="KaroSpace",
...
print("\nDone! Open Merfish_sag.html in a browser.")
