...
H5AD_PATH = '/Volumes/processing2/nature-dev-mouse-reanalysis/ad_all_processed_with_polygons_mana.h5ad'#'/Volumes/processing2/RRmap/data/EAE_proseg_clustered_louvain_leiden_all_sections_annotated_rotated_scVI_mana_embedding_clustered.h5ad'
...
export_to_html(
    ...
    marker_genes_groupby=[
       'leiden_0.5','leiden_1', 'leiden_2', 'anatomical_region', 
       'leiden_mana_0.3','leiden_mana_1.0'
    ],
...
print("\nDone! Open mouseDev-Nature.html in a browser.")
