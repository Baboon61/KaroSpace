...
H5AD_PATH = '/Volumes/processing2/RRmap/data/RREAE_5k_raw_only_integration_processed_updated_annotation_compartment_cytetype.h5ad'#'/Volumes/processing2/RRmap/data/EAE_proseg_clustered_louvain_leiden_all_sections_annotated_rotated_scVI_mana_embedding_clustered.h5ad'
...
export_to_html(
    ...
    color="cytetype_annotation_leiden_2.5",  # Initial color (categorical)
    title="KaroSpace",
...
print("\nDone! Open RRMap-V1-data.html in a browser.")
