...
H5AD_PATH = '/Volumes/processing2/BALO/baloMS-nuclei-clustered-sc.h5ad'#'/Volumes/processing2/RRmap/data/EAE_proseg_clustered_louvain_leiden_all_sections_annotated_rotated_scVI_mana_embedding_clustered.h5ad'
...
export_to_html(
    ...
    main_cells_annotation="leiden_2",  # Initial color (categorical)
    title="KaroSpace",
...
print("\nDone! Open XenSC.html in a browser.")
