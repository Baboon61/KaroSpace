...
This script is configured for the Developing Human Lung companion-ready h5ad and writes:
...
H5AD_PATH = os.environ.get(
    "LUNG_CELL_2022_H5AD_PATH",
    "/Volumes/processing/cellxgene/cellxgene_visium_merged/lung_10.1016_j.cell.2022.11.005.companion.ready.h5ad",
)

PRIMARY_COLOR = "cell_type"
ADDITIONAL_COLORS = [
    "clusters",
    "regions",
    "development_stage",
]
SIDECAR_OUTPUT = "lung-cell-2022-binary-sidecar.html"
PACKAGE_OUTPUT = "lung-cell-2022-binary.karospace"
GENE_AUX_PATH = "lung-cell-2022-binary.genes.json"

if not Path(H5AD_PATH).exists():
    raise SystemExit(
        "Developing Human Lung h5ad not found. Set LUNG_CELL_2022_H5AD_PATH before running "
        "examples/lung-cell-2022-binary-sidecar-package.py."
    )
