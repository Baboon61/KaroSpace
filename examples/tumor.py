...
H5AD_PATH = '/Users/christoffer/work/spatialist/talbot_xenium/data/talbot_xenium_tumor_annotated-with-hvg-subsetted-mana-neigh.h5ad'#'/Volumes/processing2/RRmap/data/EAE_proseg_clustered_louvain_leiden_all_sections_annotated_rotated_scVI_mana_embedding_clustered.h5ad'
...
export_to_html(
    ...
    additional_colors=[
       ...
       'leiden_mana_0.3', 'leiden_mana_0.5','leiden_mana_0.8', 'leiden_mana_1.0',
       'leiden_mana_1.5', 'leiden_mana_2'
    ],
    ...
    marker_genes_groupby=[
       'leiden_0.5',
       'leiden_1', 'leiden_1.5', 'leiden_2', 'leiden_2.5', 'leiden_3',
       'leiden_3.5', 'leiden_4', 'cytetype_annotation_leiden_4','leiden_mana_0.3', 'leiden_mana_0.5','leiden_mana_0.8', 'leiden_mana_1.0',
       'leiden_mana_1.5', 'leiden_mana_2'
    ],
...
print("\nDone! Open tumor-talbot.html in a browser.")
