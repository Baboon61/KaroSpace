...
H5AD_PATH = '/Users/chrislangseth/Internshit/260212_Kidney/data/260212_kidney_clustered_compartments.h5ad'#'/Volumes/processing2/RRmap/data/EAE_proseg_clustered_louvain_leiden_all_sections_annotated_rotated_scVI_mana_embedding_clustered.h5ad'
...
export_to_html(
    dataset,
    output_path="kidney.html",
    color="leiden_1.5",  # Initial color (categorical)
    title="KaroSpace",
