...
This script is configured for the GSE320042 Visium (Companion) companion-ready h5ad and writes:
...
PRIMARY_COLOR = "leiden_0_6"
ADDITIONAL_COLORS = [
]
SIDECAR_OUTPUT = "gse320042-visium-companion-binary-sidecar.html"
PACKAGE_OUTPUT = "gse320042-visium-companion-binary.karospace"
GENE_AUX_PATH = "gse320042-visium-companion-binary.genes.json"

if not Path(H5AD_PATH).exists():
    raise SystemExit(
        "GSE320042 Visium (Companion) h5ad not found. Set GSE320042_VISIUM_COMPANION_H5AD_PATH before running "
        "examples/gse320042-visium-companion-binary-sidecar-package.py."
    )
...
common_kwargs = dict(
    ...
    title="GSE320042 Visium (Companion)",
    min_panel_size=120,
    spot_size="auto",
