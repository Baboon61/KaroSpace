...
This script is configured for the Breast Carcinoma companion-ready h5ad and writes:
...
H5AD_PATH = os.environ.get(
    "BREAST_CARCINOMA_2021_H5AD_PATH",
...
PRIMARY_COLOR = "Classification"
ADDITIONAL_COLORS = [
    "cell_type",
    "subtype",
]
SIDECAR_OUTPUT = "breast-carcinoma-2021-binary-sidecar.html"
PACKAGE_OUTPUT = "breast-carcinoma-2021-binary.karospace"
GENE_AUX_PATH = "breast-carcinoma-2021-binary.genes.json"

if not Path(H5AD_PATH).exists():
    raise SystemExit(
        "Breast Carcinoma h5ad not found. Set BREAST_CARCINOMA_2021_H5AD_PATH before running "
        "examples/breast-carcinoma-2021-binary-sidecar-package.py."
    )
