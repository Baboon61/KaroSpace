...
PRIMARY_COLOR = "majorCluster_final"
ADDITIONAL_COLORS = [
    "Region_banksy_major",
    "Region_banksy",
]
SIDECAR_OUTPUT = "gse284005-merfish-all-binary-sidecar.html"
PACKAGE_OUTPUT = "gse284005-merfish-all-binary.karospace"
GENE_AUX_PATH = "gse284005-merfish-all-binary.genes.json"
