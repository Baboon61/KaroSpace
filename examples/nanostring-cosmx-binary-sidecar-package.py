...
This script is configured for the Nanostring CosMX companion-ready h5ad and
writes:
...
H5AD_PATH = os.environ.get(
    "NANOSTRING_COSMX_H5AD_PATH",
    "/Users/chrislangseth/Downloads/Nanostring_CosMX_v1.companion.ready.h5ad",
)

PRIMARY_COLOR = "Subclass_label"
ADDITIONAL_COLORS = [
    "Pathology",
    "module_label",
    "new_identity",
]
SIDECAR_OUTPUT = "nanostring-cosmx-binary-sidecar.html"
PACKAGE_OUTPUT = "nanostring-cosmx-binary.karospace"
GENE_AUX_PATH = "nanostring-cosmx-binary.genes.json"

if not Path(H5AD_PATH).exists():
    raise SystemExit(
        "Nanostring CosMX h5ad not found. Set NANOSTRING_COSMX_H5AD_PATH "
        "before running examples/nanostring-cosmx-binary-sidecar-package.py."
    )
...
common_kwargs = dict(
    ...
    marker_genes_groupby=[PRIMARY_COLOR, "module_label", "Pathology"],
    marker_genes_top_n=30,
    neighbor_stats_groupby=[PRIMARY_COLOR, "Pathology", "module_label"],
    neighbor_stats_permutations=0,
    neighbor_stats_seed=42,
    cluster_de_groupby=[PRIMARY_COLOR, "module_label"],
    cluster_de_top_n=20,
