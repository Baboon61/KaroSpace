...
This script is configured for the DBiT 30258697 E13 50 2 companion-ready h5ad and writes:
...
H5AD_PATH = os.environ.get(
    "DBIT_30258697_E13_50_2_H5AD_PATH",
    "/Volumes/processing2/KaroSpaceDataWrangle/dbit-30258697/E13_50_2.companion.ready.h5ad",
)

PRIMARY_COLOR = "leiden"
ADDITIONAL_COLORS = []
SIDECAR_OUTPUT = "dbit-30258697-e13-50-2-binary-sidecar.html"
PACKAGE_OUTPUT = "dbit-30258697-e13-50-2-binary.karospace"
GENE_AUX_PATH = "dbit-30258697-e13-50-2-binary.genes.json"

if not Path(H5AD_PATH).exists():
    raise SystemExit(
        "DBiT 30258697 E13 50 2 h5ad not found. Set DBIT_30258697_E13_50_2_H5AD_PATH before running "
        "examples/dbit-30258697-e13-50-2-binary-sidecar-package.py."
    )
