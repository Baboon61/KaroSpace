...
This script is configured for the GSE284089 GSM8677818 companion-ready h5ad and writes:
...
H5AD_PATH = os.environ.get(
    "GSE284089_GSM8677818_H5AD_PATH",
...
PRIMARY_COLOR = "leiden_1.0"
ADDITIONAL_COLORS = []
SIDECAR_OUTPUT = "gse284089-gsm8677818-binary-sidecar.html"
PACKAGE_OUTPUT = "gse284089-gsm8677818-binary.karospace"
GENE_AUX_PATH = "gse284089-gsm8677818-binary.genes.json"
SINGLE_SECTION_COLUMN = "__karospace_section_id"
SINGLE_SECTION_ID = "GSM8677818"

if not Path(H5AD_PATH).exists():
    raise SystemExit(
        "GSE284089 GSM8677818 h5ad not found. Set GSE284089_GSM8677818_H5AD_PATH before running "
        "examples/gse284089-gsm8677818-binary-sidecar-package.py."
    )

adata = _read_h5ad_with_fallback(H5AD_PATH)
adata.obs[SINGLE_SECTION_COLUMN] = SINGLE_SECTION_ID
