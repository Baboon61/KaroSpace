...
This script is configured for the D_SC companion-ready h5ad and writes:
...
if not Path(H5AD_PATH).exists():
    raise SystemExit(
        "D_SC h5ad not found. Set D_SC_H5AD_PATH before running "
        "examples/d-sc-binary-sidecar-package.py."
    )
