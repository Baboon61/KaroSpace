...
This script is configured for the GSE253710 companion-ready h5ad and writes:
...
SIDECAR_OUTPUT = "gse253710-binary-sidecar.html"
PACKAGE_OUTPUT = "gse253710-binary.karospace"
GENE_AUX_PATH = "gse253710-binary.genes.json"

if not Path(H5AD_PATH).exists():
    raise SystemExit(
        "GSE253710 h5ad not found. Set GSE253710_H5AD_PATH before running "
        "examples/gse253710-binary-sidecar-package.py."
    )
