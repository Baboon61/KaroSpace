...
This script is configured for the Bruker WTX Brain companion-ready h5ad and writes:
...
H5AD_PATH = os.environ.get(
    "BRUKER_WTX_BRAIN_H5AD_PATH",
    "/Users/chrislangseth/Downloads/bruker-wtx-brain.companion.ready.h5ad",
)
...
SIDECAR_OUTPUT = "bruker-wtx-brain-binary-sidecar.html"
PACKAGE_OUTPUT = "bruker-wtx-brain-binary.karospace"
GENE_AUX_PATH = "bruker-wtx-brain-binary.genes.json"

if not Path(H5AD_PATH).exists():
    raise SystemExit(
        "Bruker WTX Brain h5ad not found. Set BRUKER_WTX_BRAIN_H5AD_PATH before running "
        "examples/bruker-wtx-brain-binary-sidecar-package.py."
    )
