...
This script is configured for the adult human meninges combined cell-level h5ad
and writes:
...
if not Path(H5AD_PATH).exists():
    raise SystemExit(
        "Adult human meninges h5ad not found. Set HUMAN_MENINGES_H5AD_PATH "
        "before running examples/humanMeninges-binary-sidecar-package.py."
    )
