...
This script is configured for the Atera Human Breast Cancer companion-ready h5ad and writes:
...
ADDITIONAL_COLORS = ['CellCharter_5',
        'CellCharter_10',
        'CellCharter_15',
        'CellCharter_20',]
SIDECAR_OUTPUT = "atera-human-breast-cancer-binary-sidecar.html"
PACKAGE_OUTPUT = "atera-human-breast-cancer-binary.karospace"
GENE_AUX_PATH = "atera-human-breast-cancer-binary.genes.json"

if not Path(H5AD_PATH).exists():
    raise SystemExit(
        "Atera Human Breast Cancer h5ad not found. Set ATERA_HUMAN_BREAST_CANCER_H5AD_PATH before running "
        "examples/atera-human-breast-cancer-binary-sidecar-package.py."
    )
...
common_kwargs = dict(
    color=PRIMARY_COLOR,
    title="Atera Human Breast Cancer",
    min_panel_size=120,
    spot_size="auto",
