...
H5AD_PATH = '/Volumes/processing2/KaroSpaceDataWrangle/coxms3.h5ad'#'/Volumes/processing2/RRmap/data/EAE_proseg_clustered_louvain_leiden_all_sections_annotated_rotated_scVI_mana_embedding_clustered.h5ad'
...
export_to_html(
    ...
    cells_annotations=[ 'CellCharter_15','CellCharter_20'
    ],
...
print("\nDone! Open cosmx.html in a browser.")
