...
This script is configured for the DBiT 30258697 E13 20 Fig3 companion-ready h5ad and writes:
...
H5AD_PATH = os.environ.get(
    "DBIT_30258697_E13_20_FIG3_H5AD_PATH",
    "/Volumes/processing2/KaroSpaceDataWrangle/dbit-30258697/E13_20_fig3.companion.ready.h5ad",
)

PRIMARY_COLOR = "leiden"
ADDITIONAL_COLORS = []
SIDECAR_OUTPUT = "dbit-30258697-e13-20-fig3-binary-sidecar.html"
PACKAGE_OUTPUT = "dbit-30258697-e13-20-fig3-binary.karospace"
GENE_AUX_PATH = "dbit-30258697-e13-20-fig3-binary.genes.json"

if not Path(H5AD_PATH).exists():
    raise SystemExit(
        "DBiT 30258697 E13 20 Fig3 h5ad not found. Set DBIT_30258697_E13_20_FIG3_H5AD_PATH before running "
        "examples/dbit-30258697-e13-20-fig3-binary-sidecar-package.py."
    )
...
common_kwargs = dict(
    ...
    title="DBiT 30258697 E13 20 Fig3",
    min_panel_size=120,
    spot_size="auto",
