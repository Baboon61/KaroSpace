...
This script is configured for the Lipid Brain Atlas companion-ready h5ad and writes:
...
H5AD_PATH = os.environ.get(
    "LIPID_BRAIN_ATLAS_H5AD_PATH",
    "/Users/chrislangseth/work/karolinska_institutet/projects/KaroSpaceDataWrangling/data/zenodo_15379534/processed/lipid_brain_atlas_karospace.companion.ready.h5ad",
)

PRIMARY_COLOR = "lipizone"
ADDITIONAL_COLORS = []
SIDECAR_OUTPUT = "lipid-brain-atlas-binary-sidecar.html"
PACKAGE_OUTPUT = "lipid-brain-atlas-binary.karospace"
GENE_AUX_PATH = "lipid-brain-atlas-binary.genes.json"

if not Path(H5AD_PATH).exists():
    raise SystemExit(
        "Lipid Brain Atlas h5ad not found. Set LIPID_BRAIN_ATLAS_H5AD_PATH before running "
        "examples/lipid-brain-atlas-binary-sidecar-package.py."
    )
