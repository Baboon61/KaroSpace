...
This script is configured for the GSE282203 Combined companion-ready h5ad and writes:
...
SIDECAR_OUTPUT = "gse282203-combined-binary-sidecar.html"
PACKAGE_OUTPUT = "gse282203-combined-binary.karospace"
GENE_AUX_PATH = "gse282203-combined-binary.genes.json"

if not Path(H5AD_PATH).exists():
    raise SystemExit(
        "GSE282203 Combined h5ad not found. Set GSE282203_COMBINED_H5AD_PATH before running "
        "examples/gse282203-combined-binary-sidecar-package.py."
    )
