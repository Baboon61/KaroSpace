...
H5AD_PATH = '/Users/christoffer/work/karolinska/Dbit-analysis/data/results/rna_all_samples_clustered.h5ad'#'/Volumes/processing2/RRmap/data/EAE_proseg_clustered_louvain_leiden_all_sections_annotated_rotated_scVI_mana_embedding_clustered.h5ad'
...
export_to_html(
    ...
    main_cells_annotation='leiden_1',  # Initial color (categorical)
    title="KaroSpace",
...
print("\nDone! Open DBIT_RNA.html in a browser.")
