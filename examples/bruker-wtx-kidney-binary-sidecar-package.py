...
This script is configured for the Bruker WTX Kidney companion-ready h5ad and writes:
...
H5AD_PATH = os.environ.get(
    "BRUKER_WTX_KIDNEY_H5AD_PATH",
    "/Volumes/processing2/bruker-wtx-kidney/bruker-wtx-kidney.companion.ready.h5ad",
)

PRIMARY_COLOR = "cluster"
ADDITIONAL_COLORS = [
]
SIDECAR_OUTPUT = "bruker-wtx-kidney-binary-sidecar.html"
PACKAGE_OUTPUT = "bruker-wtx-kidney-binary.karospace"
GENE_AUX_PATH = "bruker-wtx-kidney-binary.genes.json"

if not Path(H5AD_PATH).exists():
    raise SystemExit(
        "Bruker WTX Kidney h5ad not found. Set BRUKER_WTX_KIDNEY_H5AD_PATH before running "
        "examples/bruker-wtx-kidney-binary-sidecar-package.py."
    )
